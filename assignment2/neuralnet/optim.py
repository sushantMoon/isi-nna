...
Inputs:
  ...
  - config: A dictionary containing hyperparameter values such as
    ...
    If the update rule requires caching values over many
...
perform well; however the default values of the other hyperparameters
should work well for a variety of different problems.
...
def rmsprop(x, dx, config=None):
    ...
    which uses a moving average of squared gradient
